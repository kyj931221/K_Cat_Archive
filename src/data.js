...
export const portfolioItems = [
    ...
    // --- 기획 프로젝트 ---
    {
        ...
        imgSrc: "/images/vr_webtoon_report.png", // ⭐️ 1단계에서 만든 썸네일 이미지 경로
        imgAlt: "VR 웹툰 리포트",
        ...
        link: "/report/vr_webtoon_report.html",

        buttons: [
            {
                text: "라이브 리포트",
                link: "/report/vr_webtoon_report.html", // ⭐️ public 폴더의 HTML (새 탭에서 열림)
                icon: "open_in_new"
            },
            {
                text: "PDF 다운로드",
                link: "/pdf/vr_webtoon_report.pdf", // ⭐️ public 폴더의 PDF (클릭 시 다운로드)
                icon: "download"
            }
        ],
